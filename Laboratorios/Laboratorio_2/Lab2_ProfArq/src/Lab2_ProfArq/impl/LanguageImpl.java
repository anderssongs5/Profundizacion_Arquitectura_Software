 ...
 * <ul>
 *   <li>{@link Lab2_ProfArq.impl.LanguageImpl#getIsoCode <em>Iso Code</em>}</li>
 *   <li>{@link Lab2_ProfArq.impl.LanguageImpl#getLanguageName <em>Language Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LanguageImpl extends MinimalEObjectImpl.Container implements Language {
	...
	protected EClass eStaticClass() {
		return Lab2_ProfArqPackage.Literals.LANGUAGE;
	}
	...
	public void setIsoCode(String newIsoCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lab2_ProfArqPackage.LANGUAGE__ISO_CODE, oldIsoCode, isoCode));
	}
	...
	public void setLanguageName(String newLanguageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lab2_ProfArqPackage.LANGUAGE__LANGUAGE_NAME, oldLanguageName, languageName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Lab2_ProfArqPackage.LANGUAGE__ISO_CODE:
				return getIsoCode();
			case Lab2_ProfArqPackage.LANGUAGE__LANGUAGE_NAME:
