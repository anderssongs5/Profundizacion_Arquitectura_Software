 ...
 * <ul>
 *   <li>{@link Lab2_ProfArq.impl.CountryImpl#getIsoCode <em>Iso Code</em>}</li>
 *   <li>{@link Lab2_ProfArq.impl.CountryImpl#getCountry <em>Country</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CountryImpl extends MinimalEObjectImpl.Container implements Country {
	...
	protected EClass eStaticClass() {
		return Lab2_ProfArqPackage.Literals.COUNTRY;
	}
	...
	public void setIsoCode(String newIsoCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lab2_ProfArqPackage.COUNTRY__ISO_CODE, oldIsoCode, isoCode));
	}
	...
	public void setCountry(String newCountry) {
		...
		country = newCountry;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lab2_ProfArqPackage.COUNTRY__COUNTRY, oldCountry, country));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Lab2_ProfArqPackage.COUNTRY__ISO_CODE:
				return getIsoCode();
			case Lab2_ProfArqPackage.COUNTRY__COUNTRY:
				return getCountry();
		}
