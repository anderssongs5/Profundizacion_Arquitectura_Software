...
/**
 * This is the item provider adapter for a {@link Lab2_ProfArq.Classification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassificationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Classification_age_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Classification_age_feature", "_UI_Classification_type"),
				 Lab2_ProfArqPackage.Literals.CLASSIFICATION__AGE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Classification)object).getAge();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Classification.class)) {
			case Lab2_ProfArqPackage.CLASSIFICATION__AGE:
