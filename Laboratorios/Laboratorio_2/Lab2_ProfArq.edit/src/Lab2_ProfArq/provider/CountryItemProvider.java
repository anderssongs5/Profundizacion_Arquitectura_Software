...
/**
 * This is the item provider adapter for a {@link Lab2_ProfArq.Country} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CountryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Lab2_ProfArqPackage.Literals.COUNTRY__ISO_CODE,
				 true,
				 false,
				 false,
	...
	protected void addCountryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Country_country_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Country_country_feature", "_UI_Country_type"),
				 Lab2_ProfArqPackage.Literals.COUNTRY__COUNTRY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Country)object).getIsoCode();
