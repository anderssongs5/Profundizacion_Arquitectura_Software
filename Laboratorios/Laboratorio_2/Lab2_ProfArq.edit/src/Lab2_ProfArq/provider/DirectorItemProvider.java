...
/**
 * This is the item provider adapter for a {@link Lab2_ProfArq.Director} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Lab2_ProfArqPackage.Literals.DIRECTOR__FULL_NAME,
				 true,
				 false,
				 false,
	...
	protected void addMoviesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Director_movies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Director_movies_feature", "_UI_Director_type"),
				 Lab2_ProfArqPackage.Literals.DIRECTOR__MOVIES,
				 true,
				 false,
				 true,
				 null,
