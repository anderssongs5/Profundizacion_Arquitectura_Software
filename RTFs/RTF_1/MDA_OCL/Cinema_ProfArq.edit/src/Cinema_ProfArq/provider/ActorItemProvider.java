...
/**
 * This is the item provider adapter for a {@link Cinema_ProfArq.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_fullName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_fullName_feature", "_UI_Actor_type"),
				 Cinema_ProfArqPackage.Literals.ACTOR__FULL_NAME,
				 true,
				 false,
				 false,
	...
	protected void addMotionPicturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_motionPictures_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_motionPictures_feature", "_UI_Actor_type"),
				 Cinema_ProfArqPackage.Literals.ACTOR__MOTION_PICTURES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Actor)object).getFullName();
