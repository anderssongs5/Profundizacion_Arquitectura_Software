...
/**
 * This is the item provider adapter for a {@link Cinema_ProfArq.Card} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CardItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Card_idNum_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Card_idNum_feature", "_UI_Card_type"),
				 Cinema_ProfArqPackage.Literals.CARD__ID_NUM,
				 true,
				 false,
				 false,
	...
	protected void addPointsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Card_points_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Card_points_feature", "_UI_Card_type"),
				 Cinema_ProfArqPackage.Literals.CARD__POINTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Card_type") + " " + card.getIdNum();
	}
