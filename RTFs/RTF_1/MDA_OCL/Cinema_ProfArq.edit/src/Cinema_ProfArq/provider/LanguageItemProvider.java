...
/**
 * This is the item provider adapter for a {@link Cinema_ProfArq.Language} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LanguageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Cinema_ProfArqPackage.Literals.LANGUAGE__ISO_CODE,
				 true,
				 false,
				 false,
	...
	protected void addLanguageNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Language_languageName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Language_languageName_feature", "_UI_Language_type"),
				 Cinema_ProfArqPackage.Literals.LANGUAGE__LANGUAGE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Language)object).getLanguageName();
