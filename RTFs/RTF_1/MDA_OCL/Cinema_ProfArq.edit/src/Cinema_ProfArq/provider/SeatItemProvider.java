...
/**
 * This is the item provider adapter for a {@link Cinema_ProfArq.Seat} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SeatItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Seat_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Seat_number_feature", "_UI_Seat_type"),
				 Cinema_ProfArqPackage.Literals.SEAT__NUMBER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Cinema_ProfArqPackage.Literals.SEAT__ROW,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLocalityTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Seat_localityType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Seat_localityType_feature", "_UI_Seat_type"),
				 Cinema_ProfArqPackage.Literals.SEAT__LOCALITY_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Seat)object).getNumber();
