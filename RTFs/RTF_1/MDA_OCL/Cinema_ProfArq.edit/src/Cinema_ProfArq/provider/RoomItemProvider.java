...
/**
 * This is the item provider adapter for a {@link Cinema_ProfArq.Room} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoomItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Cinema_ProfArqPackage.Literals.ROOM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Room_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Room_number_feature", "_UI_Room_type"),
				 Cinema_ProfArqPackage.Literals.ROOM__NUMBER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Cinema_ProfArqPackage.Literals.ROOM__SEATS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Room.class)) {
			case Cinema_ProfArqPackage.ROOM__NAME:
			case Cinema_ProfArqPackage.ROOM__NUMBER:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Cinema_ProfArqPackage.ROOM__SEATS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Cinema_ProfArqPackage.Literals.ROOM__SEATS,
				 Cinema_ProfArqFactory.eINSTANCE.createSeat()));
	}
