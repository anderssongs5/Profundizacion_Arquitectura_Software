 ...
 * <ul>
 *   <li>{@link Cinema_ProfArq.impl.DirectorImpl#getFullName <em>Full Name</em>}</li>
 *   <li>{@link Cinema_ProfArq.impl.DirectorImpl#getFilms <em>Films</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DirectorImpl extends MinimalEObjectImpl.Container implements Director {
	...
	protected EClass eStaticClass() {
		return Cinema_ProfArqPackage.Literals.DIRECTOR;
	}
	...
	public void setFullName(String newFullName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cinema_ProfArqPackage.DIRECTOR__FULL_NAME, oldFullName, fullName));
	}
	...
	public EList<Film> getFilms() {
		if (films == null) {
			films = new EObjectWithInverseResolvingEList.ManyInverse<Film>(Film.class, this, Cinema_ProfArqPackage.DIRECTOR__FILMS, Cinema_ProfArqPackage.FILM__DIRECTORS);
		}
		return films;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cinema_ProfArqPackage.DIRECTOR__FILMS:
