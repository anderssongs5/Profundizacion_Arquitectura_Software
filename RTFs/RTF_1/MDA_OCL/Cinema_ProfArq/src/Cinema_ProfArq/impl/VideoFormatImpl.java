 ...
 * <ul>
 *   <li>{@link Cinema_ProfArq.impl.VideoFormatImpl#getVideoFormat <em>Video Format</em>}</li>
 *   <li>{@link Cinema_ProfArq.impl.VideoFormatImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VideoFormatImpl extends MinimalEObjectImpl.Container implements VideoFormat {
	...
	protected EClass eStaticClass() {
		return Cinema_ProfArqPackage.Literals.VIDEO_FORMAT;
	}
	...
	public void setVideoFormat(String newVideoFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cinema_ProfArqPackage.VIDEO_FORMAT__VIDEO_FORMAT, oldVideoFormat, videoFormat));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cinema_ProfArqPackage.VIDEO_FORMAT__DESCRIPTION, oldDescription, description));
	}
