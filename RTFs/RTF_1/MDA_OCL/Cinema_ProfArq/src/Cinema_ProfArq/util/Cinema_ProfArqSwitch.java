 ...
 * @generated
 */
public class Cinema_ProfArqSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Cinema_ProfArqPackage.THEATER: {
				Theater theater = (Theater)theEObject;
				T result = caseTheater(theater);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Cinema_ProfArqPackage.BILLBOARD: {
				Billboard billboard = (Billboard)theEObject;
				T result = caseBillboard(billboard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Cinema_ProfArqPackage.AUDIO_FORMAT: {
				AudioFormat audioFormat = (AudioFormat)theEObject;
				T result = caseAudioFormat(audioFormat);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Cinema_ProfArqPackage.VIDEO_FORMAT: {
				VideoFormat videoFormat = (VideoFormat)theEObject;
				T result = caseVideoFormat(videoFormat);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Theater</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Theater</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTheater(Theater object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Billboard</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Billboard</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBillboard(Billboard object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Audio Format</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Audio Format</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAudioFormat(AudioFormat object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Video Format</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Video Format</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVideoFormat(VideoFormat object) {
		return null;
	}
